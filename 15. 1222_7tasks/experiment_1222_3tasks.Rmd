...
Write .csv file
```{r}
write.xlsx(bb,"case6data1.xlsx",sheetName="bb",append=FALSE)
write.xlsx(bhat,"case6data1.xlsx",sheetName="bhat",append=TRUE)
write.xlsx(yy,"case6data1.xlsx",sheetName="yy",append=TRUE)
```
...
```{r}
getXy()
PDC = sapply(seq(3,6,by=1), estimate_PDC, estimated_A = true_var, b_current = b)
plot(PDC)
```
