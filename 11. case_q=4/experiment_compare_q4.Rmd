...
Write .csv file
```{r}
write.xlsx(bb,"case2data2.xlsx",sheetName="bb",append=FALSE)
write.xlsx(bhat,"case2data2.xlsx",sheetName="bhat",append=TRUE)
write.xlsx(yy,"case2data2.xlsx",sheetName="yy",append=TRUE)
```
